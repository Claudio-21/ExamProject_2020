...
<html>
  ...
  <body>
     ...
     <div class="container-fluid">
       ...
       <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item active">
          <a class="nav-link text-dark" href="ricette.php">Ricette</a>
        </li>
    ...
    <br><br><br>
     ...
     <hr class="my-4">
     <p class="text-danger">Quantità da usare minore di quella in dispensa</p>
     <p class="text-success">Quantità da usare maggiore di quella in dispensa</p>
   </div>
   ...
   <!-- nested columns -->
    <div class="row justify-content-center">
     <!-- first nested column -->
       <div class="col-sm-6">
         <?php
          echo bulidInfoRicetta($_GET['idProdotto']);
         ?>
       </div>
    </div>
  </body>
